# C 074 — FNV-1a Educational Hash and Test Vector

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–073
**Companion program:** [`examples/c/c-074-fnv1a-toy-hash-and-test-vector.c`](../../examples/c/c-074-fnv1a-toy-hash-and-test-vector.c)
**Deterministic test:** [`tests/c-074-fnv1a-toy-hash-and-test-vector.sh`](../../tests/c-074-fnv1a-toy-hash-and-test-vector.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compute an educational non-cryptographic FNV-1a byte hash and verify a fixed vector.
...
FNV-1a is presented only as a teaching hash; do not use it for passwords, signatures, or hostile input.
