...
**Prerequisites:** C 001–169
**Companion program:** [`examples/c/c-170-bounded-work-per-input.c`](../../examples/c/c-170-bounded-work-per-input.c)
**Deterministic test:** [`tests/c-170-bounded-work-per-input.sh`](../../tests/c-170-bounded-work-per-input.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to connect input length and configured limits to a deliberate upper bound on parser work.
...
Defensive code considers time as well as bytes. Avoid loops whose total work can grow unexpectedly from nested or repeated input.
