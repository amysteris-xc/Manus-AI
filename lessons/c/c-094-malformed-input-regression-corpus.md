...
**Prerequisites:** C 001–093
**Companion program:** [`examples/c/c-094-malformed-input-regression-corpus.c`](../../examples/c/c-094-malformed-input-regression-corpus.c)
**Deterministic test:** [`tests/c-094-malformed-input-regression-corpus.sh`](../../tests/c-094-malformed-input-regression-corpus.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to preserve a small set of malformed byte cases as deterministic regression tests.
...
Regression cases keep previously fixed boundary failures from silently returning.
