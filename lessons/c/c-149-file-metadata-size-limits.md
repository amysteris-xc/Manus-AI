...
**Prerequisites:** C 001–148
**Companion program:** [`examples/c/c-149-file-metadata-size-limits.c`](../../examples/c/c-149-file-metadata-size-limits.c)
**Deterministic test:** [`tests/c-149-file-metadata-size-limits.sh`](../../tests/c-149-file-metadata-size-limits.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to treat file-size metadata as untrusted until it passes conversion and configured-size checks.
...
A file’s reported size may be unsuitable for allocation. Check API errors, signedness, `size_t` conversion, and a deliberate maximum.
