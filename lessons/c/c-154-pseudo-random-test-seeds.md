...
**Prerequisites:** C 001–153
**Companion program:** [`examples/c/c-154-pseudo-random-test-seeds.c`](../../examples/c/c-154-pseudo-random-test-seeds.c)
**Deterministic test:** [`tests/c-154-pseudo-random-test-seeds.sh`](../../tests/c-154-pseudo-random-test-seeds.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to use a documented pseudo-random seed to vary non-secret test bytes reproducibly.
...
A predictable generator is useful for tests only. Never use it for keys, passwords, nonces, or security decisions.
