...
**Prerequisites:** C 001–128
**Companion program:** [`examples/c/c-129-feature-flag-format-gating.c`](../../examples/c/c-129-feature-flag-format-gating.c)
**Deterministic test:** [`tests/c-129-feature-flag-format-gating.sh`](../../tests/c-129-feature-flag-format-gating.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to accept an optional format feature only when its flag and length are both valid.
...
A feature flag changes parsing only after the enclosing record is already valid enough to read it safely.
