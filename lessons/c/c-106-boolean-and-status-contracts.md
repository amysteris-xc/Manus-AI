...
**Prerequisites:** C 001–105
**Companion program:** [`examples/c/c-106-boolean-and-status-contracts.c`](../../examples/c/c-106-boolean-and-status-contracts.c)
**Deterministic test:** [`tests/c-106-boolean-and-status-contracts.sh`](../../tests/c-106-boolean-and-status-contracts.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to choose a clear return contract for a helper that validates byte input.
...
Use a Boolean only for a single success/failure question; use named status values when callers need to distinguish failure causes.
