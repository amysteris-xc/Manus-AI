...
**Prerequisites:** C 001–168
**Companion program:** [`examples/c/c-169-message-count-limits.c`](../../examples/c/c-169-message-count-limits.c)
**Deterministic test:** [`tests/c-169-message-count-limits.sh`](../../tests/c-169-message-count-limits.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to reject a sequence that exceeds a documented maximum number of records.
...
Message-count limits bound total work and storage even if each individual message fits its local size limit.
