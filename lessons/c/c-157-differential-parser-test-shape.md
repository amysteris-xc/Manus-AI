...
**Prerequisites:** C 001–156
**Companion program:** [`examples/c/c-157-differential-parser-test-shape.c`](../../examples/c/c-157-differential-parser-test-shape.c)
**Deterministic test:** [`tests/c-157-differential-parser-test-shape.sh`](../../tests/c-157-differential-parser-test-shape.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compare two safe educational parser paths on the same fixed byte inputs.
...
Differential testing compares stated behavior; it does not establish that either implementation is secure or complete.
