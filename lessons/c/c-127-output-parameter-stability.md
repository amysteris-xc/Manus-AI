...
**Prerequisites:** C 001–126
**Companion program:** [`examples/c/c-127-output-parameter-stability.c`](../../examples/c/c-127-output-parameter-stability.c)
**Deterministic test:** [`tests/c-127-output-parameter-stability.sh`](../../tests/c-127-output-parameter-stability.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to leave an output parameter unchanged when an input contract fails.
...
Stable outputs make failure safer to call. Validate inputs before assigning a new result to an output location.
