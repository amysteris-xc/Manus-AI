...
**Prerequisites:** C 001–193
**Companion program:** [`examples/c/c-194-test-vector-packaging.c`](../../examples/c/c-194-test-vector-packaging.c)
**Deterministic test:** [`tests/c-194-test-vector-packaging.sh`](../../tests/c-194-test-vector-packaging.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to package a fixed byte input, expected output, and version label as a reproducible test vector.
...
A vector should be unambiguous and non-secret. It supports regression and interoperability testing but does not by itself prove security.
