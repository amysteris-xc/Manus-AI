...
**Prerequisites:** C 001–116
**Companion program:** [`examples/c/c-117-unknown-field-skipping.c`](../../examples/c/c-117-unknown-field-skipping.c)
**Deterministic test:** [`tests/c-117-unknown-field-skipping.sh`](../../tests/c-117-unknown-field-skipping.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to skip a length-delimited unknown field only after validating its declared size.
...
Extensibility is safe only when an unknown field’s length is checked against remaining bytes and configured limits.
