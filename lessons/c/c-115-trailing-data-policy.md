...
**Prerequisites:** C 001–114
**Companion program:** [`examples/c/c-115-trailing-data-policy.c`](../../examples/c/c-115-trailing-data-policy.c)
**Deterministic test:** [`tests/c-115-trailing-data-policy.sh`](../../tests/c-115-trailing-data-policy.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to define and test whether a parser accepts, rejects, or reports bytes after a complete record.
...
Trailing bytes are part of a format decision. Make the policy explicit rather than ignoring unexpected input by accident.
