...
**Prerequisites:** C 001–072
**Companion program:** [`examples/c/c-073-streaming-crc32-integrity-check.c`](../../examples/c/c-073-streaming-crc32-integrity-check.c)
**Deterministic test:** [`tests/c-073-streaming-crc32-integrity-check.sh`](../../tests/c-073-streaming-crc32-integrity-check.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compute an explicitly non-cryptographic CRC-32-style integrity value over a byte sequence.
...
CRC detects many accidental changes but is not authentication, encryption, or a cryptographic hash.
