...
**Prerequisites:** C 001–167
**Companion program:** [`examples/c/c-168-nesting-depth-caps.c`](../../examples/c/c-168-nesting-depth-caps.c)
**Deterministic test:** [`tests/c-168-nesting-depth-caps.sh`](../../tests/c-168-nesting-depth-caps.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to enforce a small maximum nesting level in a demonstration parser state.
...
Depth is a resource limit. Increment only for validated opens, decrement only for matching closes, and reject exceeding the cap.
