...
**Prerequisites:** C 001–134
**Companion program:** [`examples/c/c-135-nested-subrange-checks.c`](../../examples/c/c-135-nested-subrange-checks.c)
**Deterministic test:** [`tests/c-135-nested-subrange-checks.sh`](../../tests/c-135-nested-subrange-checks.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to validate an inner byte range against an already validated outer range.
...
Each nested length must be checked against the parent’s remaining bytes and a configured maximum before it is used.
