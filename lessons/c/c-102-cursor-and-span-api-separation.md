...
**Prerequisites:** C 001–101
**Companion program:** [`examples/c/c-102-cursor-and-span-api-separation.c`](../../examples/c/c-102-cursor-and-span-api-separation.c)
**Deterministic test:** [`tests/c-102-cursor-and-span-api-separation.sh`](../../tests/c-102-cursor-and-span-api-separation.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to separate a counted byte span from a mutable cursor so each contract stays inspectable.
...
A span names data and length; a cursor adds a current position. Do not advance the cursor until the read succeeds.
