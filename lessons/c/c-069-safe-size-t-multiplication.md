...
By the end of this lesson, you should be able to detect size multiplication overflow before calculating record storage requirements.
...
Never compute `count * item_size` until proving it fits in `size_t`.
