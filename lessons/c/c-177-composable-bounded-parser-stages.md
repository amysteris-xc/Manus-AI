...
**Prerequisites:** C 001–176
**Companion program:** [`examples/c/c-177-composable-bounded-parser-stages.c`](../../examples/c/c-177-composable-bounded-parser-stages.c)
**Deterministic test:** [`tests/c-177-composable-bounded-parser-stages.sh`](../../tests/c-177-composable-bounded-parser-stages.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compose two bounded parsing stages where the second begins only after the first succeeds.
...
Stages communicate explicit remainder length and status. Do not continue after a malformed prefix or silently reinterpret bytes.
