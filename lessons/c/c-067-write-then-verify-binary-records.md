...
**Prerequisites:** C 001–066
**Companion program:** [`examples/c/c-067-write-then-verify-binary-records.c`](../../examples/c/c-067-write-then-verify-binary-records.c)
**Deterministic test:** [`tests/c-067-write-then-verify-binary-records.sh`](../../tests/c-067-write-then-verify-binary-records.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to write a fixed binary record and read it back with checked object counts.
...
A write result and a later read result are separate contracts and both need verification.
