...
**Prerequisites:** C 001–106
**Companion program:** [`examples/c/c-107-bounded-growth-policy.c`](../../examples/c/c-107-bounded-growth-policy.c)
**Deterministic test:** [`tests/c-107-bounded-growth-policy.sh`](../../tests/c-107-bounded-growth-policy.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to apply a maximum capacity and checked arithmetic before growing a byte buffer.
...
Growth rules must check both arithmetic overflow and a deliberate resource cap before allocating.
