...
**Prerequisites:** C 001–157
**Companion program:** [`examples/c/c-158-property-test-invariants.c`](../../examples/c/c-158-property-test-invariants.c)
**Deterministic test:** [`tests/c-158-property-test-invariants.sh`](../../tests/c-158-property-test-invariants.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to state and test a small invariant over a fixed range of counted byte inputs.
...
An invariant is a precise property, such as encode then decode preserving a value. Bound the domain so failures are reproducible.
