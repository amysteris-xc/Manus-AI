...
**Prerequisites:** C 001–141
**Companion program:** [`examples/c/c-142-checked-output-encoding-length.c`](../../examples/c/c-142-checked-output-encoding-length.c)
**Deterministic test:** [`tests/c-142-checked-output-encoding-length.sh`](../../tests/c-142-checked-output-encoding-length.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to calculate a bounded encoded-output length with checked addition and multiplication.
...
Encoding expands data. Prove the result fits both `size_t` and the configured output maximum before allocating or writing.
