...
**Prerequisites:** C 001–065
**Companion program:** [`examples/c/c-066-checked-file-offset-and-size-queries.c`](../../examples/c/c-066-checked-file-offset-and-size-queries.c)
**Deterministic test:** [`tests/c-066-checked-file-offset-and-size-queries.sh`](../../tests/c-066-checked-file-offset-and-size-queries.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to obtain a small file size through checked seek and tell operations without assuming success.
...
File position APIs can fail; every status and conversion must be checked before using the result.
