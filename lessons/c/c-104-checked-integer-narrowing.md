...
**Prerequisites:** C 001–103
**Companion program:** [`examples/c/c-104-checked-integer-narrowing.c`](../../examples/c/c-104-checked-integer-narrowing.c)
**Deterministic test:** [`tests/c-104-checked-integer-narrowing.sh`](../../tests/c-104-checked-integer-narrowing.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to reject a value before narrowing it to a smaller unsigned integer type.
...
A cast can silently discard high bits. Check a value against the destination maximum before converting it.
