...
**Prerequisites:** C 001–145
**Companion program:** [`examples/c/c-146-journal-recovery-boundaries.c`](../../examples/c/c-146-journal-recovery-boundaries.c)
**Deterministic test:** [`tests/c-146-journal-recovery-boundaries.sh`](../../tests/c-146-journal-recovery-boundaries.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to read a simple journal record sequence and stop safely at a truncated final record.
...
Recovery distinguishes clean end-of-file from I/O error and malformed or partial record data. Do not invent missing bytes.
