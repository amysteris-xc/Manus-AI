...
**Prerequisites:** C 001–158
**Companion program:** [`examples/c/c-159-metamorphic-byte-transform-tests.c`](../../examples/c/c-159-metamorphic-byte-transform-tests.c)
**Deterministic test:** [`tests/c-159-metamorphic-byte-transform-tests.sh`](../../tests/c-159-metamorphic-byte-transform-tests.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to test a relationship between an input and a transformed input without requiring a separate oracle for every case.
...
A metamorphic relation must be documented and bounded. It supplements, rather than replaces, known-answer tests.
