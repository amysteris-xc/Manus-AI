...
**Prerequisites:** C 001–159
**Companion program:** [`examples/c/c-160-minimal-repro-case-format.c`](../../examples/c/c-160-minimal-repro-case-format.c)
**Deterministic test:** [`tests/c-160-minimal-repro-case-format.sh`](../../tests/c-160-minimal-repro-case-format.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to record a minimal byte input and expected status for a regression case.
...
A compact reproduction includes input bytes, length, expected result, and the prior bug condition without exposing sensitive real data.
