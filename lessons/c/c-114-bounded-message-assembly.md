...
**Prerequisites:** C 001–113
**Companion program:** [`examples/c/c-114-bounded-message-assembly.c`](../../examples/c/c-114-bounded-message-assembly.c)
**Deterministic test:** [`tests/c-114-bounded-message-assembly.sh`](../../tests/c-114-bounded-message-assembly.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to assemble a small message from counted parts while enforcing an output capacity.
...
Each append must prove remaining capacity before changing a write position. Embedded zero bytes remain ordinary data.
