...
**Prerequisites:** C 001–084
**Companion program:** [`examples/c/c-085-text-encoding-and-byte-boundaries-review.c`](../../examples/c/c-085-text-encoding-and-byte-boundaries-review.c)
**Deterministic test:** [`tests/c-085-text-encoding-and-byte-boundaries-review.sh`](../../tests/c-085-text-encoding-and-byte-boundaries-review.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to separate UTF-8-like text bytes from C string assumptions in a counted buffer interface.
...
Text encoding is data; raw bytes need a length even when a display layer uses strings.
