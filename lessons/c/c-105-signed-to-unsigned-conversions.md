# C 105 — Signed-to-Unsigned Conversion Boundaries

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–104
**Companion program:** [`examples/c/c-105-signed-to-unsigned-conversions.c`](../../examples/c/c-105-signed-to-unsigned-conversions.c)
**Deterministic test:** [`tests/c-105-signed-to-unsigned-conversions.sh`](../../tests/c-105-signed-to-unsigned-conversions.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to validate a signed value before using it as an unsigned count or offset.
...
Negative values must be rejected before conversion. A later bounds check cannot repair an unsafe earlier conversion.
