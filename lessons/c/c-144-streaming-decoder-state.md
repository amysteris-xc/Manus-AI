...
**Prerequisites:** C 001–143
**Companion program:** [`examples/c/c-144-streaming-decoder-state.c`](../../examples/c/c-144-streaming-decoder-state.c)
**Deterministic test:** [`tests/c-144-streaming-decoder-state.sh`](../../tests/c-144-streaming-decoder-state.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to carry a small decoder state across chunks and reject an invalid final partial unit.
...
End-of-stream validation is separate from per-chunk validation. Do not accept leftover partial data as a complete value.
