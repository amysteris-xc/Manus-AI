...
**Prerequisites:** C 001–079
**Companion program:** [`examples/c/c-080-round-trip-property-checks.c`](../../examples/c/c-080-round-trip-property-checks.c)
**Deterministic test:** [`tests/c-080-round-trip-property-checks.sh`](../../tests/c-080-round-trip-property-checks.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to test an encoder and decoder round trip using a fixed set of safe test values.
...
Round-trip tests confirm a stated invariant but do not prove absence of every bug.
