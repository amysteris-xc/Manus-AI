...
**Prerequisites:** C 001–130
**Companion program:** [`examples/c/c-131-error-code-coverage.c`](../../examples/c/c-131-error-code-coverage.c)
**Deterministic test:** [`tests/c-131-error-code-coverage.sh`](../../tests/c-131-error-code-coverage.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to exercise each named error result of a small parser with a deterministic case.
...
Error paths are part of the public contract. Tests should distinguish bad arguments, truncated input, and malformed fields.
