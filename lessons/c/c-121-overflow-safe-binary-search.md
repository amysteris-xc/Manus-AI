...
**Prerequisites:** C 001–120
**Companion program:** [`examples/c/c-121-overflow-safe-binary-search.c`](../../examples/c/c-121-overflow-safe-binary-search.c)
**Deterministic test:** [`tests/c-121-overflow-safe-binary-search.sh`](../../tests/c-121-overflow-safe-binary-search.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to search a sorted counted table using a midpoint calculation that cannot overflow.
...
Use `low + (high - low) / 2` with validated bounds rather than an unchecked sum of indexes.
