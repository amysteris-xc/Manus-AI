...
**Prerequisites:** C 001–115
**Companion program:** [`examples/c/c-116-version-migration-dispatch.c`](../../examples/c/c-116-version-migration-dispatch.c)
**Deterministic test:** [`tests/c-116-version-migration-dispatch.sh`](../../tests/c-116-version-migration-dispatch.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to dispatch a bounded record to an allowed version handler and reject unsupported versions.
...
A version field selects a documented parser path. Unknown versions must not be interpreted as a nearby known version.
