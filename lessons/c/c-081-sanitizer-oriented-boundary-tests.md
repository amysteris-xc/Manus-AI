...
**Prerequisites:** C 001–080
**Companion program:** [`examples/c/c-081-sanitizer-oriented-boundary-tests.c`](../../examples/c/c-081-sanitizer-oriented-boundary-tests.c)
**Deterministic test:** [`tests/c-081-sanitizer-oriented-boundary-tests.sh`](../../tests/c-081-sanitizer-oriented-boundary-tests.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to exercise zero-length, full-capacity, and rejected-capacity byte inputs under strict compiler diagnostics.
...
Sanitizers complement tests by detecting undefined behavior that output comparisons may miss.
