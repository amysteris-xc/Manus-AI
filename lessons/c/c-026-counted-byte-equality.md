...
**Companion program:** [`examples/c/c-026-counted-byte-equality.c`](../../examples/c/c-026-counted-byte-equality.c)
**Deterministic test:** [`tests/c-026-counted-byte-equality.sh`](../../tests/c-026-counted-byte-equality.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compare two byte buffers with an explicit count and demonstrate that embedded zero bytes are ordinary data.
