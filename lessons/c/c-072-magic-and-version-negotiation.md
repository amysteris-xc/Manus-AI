...
By the end of this lesson, you should be able to check a byte-format magic and an allowed version before handling a body.
...
Reject unknown magic and versions before accepting any subsequent format field.
