# C 110 — Aliasing and the `memcpy` Boundary

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–109
**Companion program:** [`examples/c/c-110-aliasing-and-memcpy-boundary.c`](../../examples/c/c-110-aliasing-and-memcpy-boundary.c)
**Deterministic test:** [`tests/c-110-aliasing-and-memcpy-boundary.sh`](../../tests/c-110-aliasing-and-memcpy-boundary.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to move counted bytes through `memcpy` or `memmove` only after validating both ranges.
...
Byte copies need source-length, destination-capacity, and overlap rules. Do not type-pun arbitrary objects through unsafe pointer casts.
