...
**Prerequisites:** C 001–039 and the immediately preceding lessons
**Companion program:** [`examples/c/c-040-lookup-table-bit-count-calculation.c`](../../examples/c/c-040-lookup-table-bit-count-calculation.c)
**Deterministic test:** [`tests/c-040-lookup-table-bit-count-calculation.sh`](../../tests/c-040-lookup-table-bit-count-calculation.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to count active bits (popcount) across a byte stream using a precomputed 16-entry nibble table.
