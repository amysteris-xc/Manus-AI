...
**Prerequisites:** C 001–112
**Companion program:** [`examples/c/c-113-sequence-gap-detection.c`](../../examples/c/c-113-sequence-gap-detection.c)
**Deterministic test:** [`tests/c-113-sequence-gap-detection.sh`](../../tests/c-113-sequence-gap-detection.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to detect an expected next sequence value and report a gap without advancing accepted state.
...
State changes follow validated input. A rejected gap must not silently become the new expected value.
