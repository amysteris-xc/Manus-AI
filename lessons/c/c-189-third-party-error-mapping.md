...
**Prerequisites:** C 001–188
**Companion program:** [`examples/c/c-189-third-party-error-mapping.c`](../../examples/c/c-189-third-party-error-mapping.c)
**Deterministic test:** [`tests/c-189-third-party-error-mapping.sh`](../../tests/c-189-third-party-error-mapping.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to map a small external-style result into local named statuses without losing failure meaning.
...
Error mapping should preserve actionable distinctions while avoiding leaking sensitive details. Consult actual library documentation in production.
