# C 138 — Hex Encoding Round Trip

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–137
**Companion program:** [`examples/c/c-138-hex-encode-round-trip.c`](../../examples/c/c-138-hex-encode-round-trip.c)
**Deterministic test:** [`tests/c-138-hex-encode-round-trip.sh`](../../tests/c-138-hex-encode-round-trip.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to render a byte buffer as hexadecimal and confirm the encoded representation is bounded.
...
Hex encoding expands each byte predictably. Output capacity must account for two characters per byte plus an optional terminator.
