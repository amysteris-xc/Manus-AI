...
**Prerequisites:** C 001–154
**Companion program:** [`examples/c/c-155-fuzz-harness-entry-contract.c`](../../examples/c/c-155-fuzz-harness-entry-contract.c)
**Deterministic test:** [`tests/c-155-fuzz-harness-entry-contract.sh`](../../tests/c-155-fuzz-harness-entry-contract.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to define a bounded parser entry point suitable for a fuzzer-style caller.
...
A fuzz target should accept pointer-plus-length input, reject null with nonzero length, and avoid side effects outside controlled test data.
