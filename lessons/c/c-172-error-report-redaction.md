...
**Prerequisites:** C 001–171
**Companion program:** [`examples/c/c-172-error-report-redaction.c`](../../examples/c/c-172-error-report-redaction.c)
**Deterministic test:** [`tests/c-172-error-report-redaction.sh`](../../tests/c-172-error-report-redaction.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to produce a generic error code rather than echoing a sensitive-looking byte value.
...
Error reporting should help diagnosis without exposing secrets or untrusted content. This is a design boundary, not a cryptographic guarantee.
