...
**Prerequisites:** C 001–182
**Companion program:** [`examples/c/c-183-canonical-input-rejection.c`](../../examples/c/c-183-canonical-input-rejection.c)
**Deterministic test:** [`tests/c-183-canonical-input-rejection.sh`](../../tests/c-183-canonical-input-rejection.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to reject a non-canonical representation when the format requires one unambiguous form.
...
Canonical validation prevents multiple byte spellings of the same value. It is a format rule, not a replacement for authentication.
