...
**Prerequisites:** C 001–058
**Companion program:** [`examples/c/c-059-checked-sequence-number-tracking.c`](../../examples/c/c-059-checked-sequence-number-tracking.c)
**Deterministic test:** [`tests/c-059-checked-sequence-number-tracking.sh`](../../tests/c-059-checked-sequence-number-tracking.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to track a bounded monotonically increasing packet sequence and reject unexpected input.
...
A sequence tracker separates accepted state from rejected packet input.
