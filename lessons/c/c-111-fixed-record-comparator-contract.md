...
**Prerequisites:** C 001–110
**Companion program:** [`examples/c/c-111-fixed-record-comparator-contract.c`](../../examples/c/c-111-fixed-record-comparator-contract.c)
**Deterministic test:** [`tests/c-111-fixed-record-comparator-contract.sh`](../../tests/c-111-fixed-record-comparator-contract.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compare fixed-width byte records using an explicit record width and count.
...
A comparator needs a stable width, validated pointers, and a documented ordering. Do not read past the record boundary.
