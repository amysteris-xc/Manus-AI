...
**Prerequisites:** C 001–195
**Companion program:** [`examples/c/c-196-reproducible-build-metadata.c`](../../examples/c/c-196-reproducible-build-metadata.c)
**Deterministic test:** [`tests/c-196-reproducible-build-metadata.sh`](../../tests/c-196-reproducible-build-metadata.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to record non-secret build inputs such as compiler flags and source version in a small demonstration.
...
Reproducibility requires documented inputs. Avoid embedding timestamps, absolute paths, credentials, or system-specific accidental data in artifacts.
