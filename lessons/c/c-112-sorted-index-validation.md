...
**Prerequisites:** C 001–111
**Companion program:** [`examples/c/c-112-sorted-index-validation.c`](../../examples/c/c-112-sorted-index-validation.c)
**Deterministic test:** [`tests/c-112-sorted-index-validation.sh`](../../tests/c-112-sorted-index-validation.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to validate a small sorted index before relying on it for lookup.
...
An index contract includes sorted order, count, and range validity. A failed validation should leave the output unchanged.
