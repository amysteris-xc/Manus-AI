...
**Prerequisites:** C 001–170
**Companion program:** [`examples/c/c-171-safe-untrusted-input-logging.c`](../../examples/c/c-171-safe-untrusted-input-logging.c)
**Deterministic test:** [`tests/c-171-safe-untrusted-input-logging.sh`](../../tests/c-171-safe-untrusted-input-logging.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to log a bounded summary of untrusted bytes without treating them as a C string.
...
Diagnostics should limit length, use safe hex rendering, and avoid revealing sensitive or unnecessary input content.
