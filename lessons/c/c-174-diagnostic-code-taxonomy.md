...
**Prerequisites:** C 001–173
**Companion program:** [`examples/c/c-174-diagnostic-code-taxonomy.c`](../../examples/c/c-174-diagnostic-code-taxonomy.c)
**Deterministic test:** [`tests/c-174-diagnostic-code-taxonomy.sh`](../../tests/c-174-diagnostic-code-taxonomy.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to assign stable named diagnostic categories to argument, truncation, and format failures.
...
Codes make failures machine-checkable while messages remain human-readable. Do not expose implementation internals as a security claim.
