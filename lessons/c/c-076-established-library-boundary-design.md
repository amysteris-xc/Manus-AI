...
**Prerequisites:** C 001–075
**Companion program:** [`examples/c/c-076-established-library-boundary-design.c`](../../examples/c/c-076-established-library-boundary-design.c)
**Deterministic test:** [`tests/c-076-established-library-boundary-design.sh`](../../tests/c-076-established-library-boundary-design.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to design a narrow byte-buffer interface that could call an established cryptographic library without reimplementing primitives.
...
Production cryptography belongs behind a reviewed library boundary; this lesson deliberately does not implement a cryptographic primitive.
