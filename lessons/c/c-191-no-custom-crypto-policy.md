...
**Prerequisites:** C 001–190
**Companion program:** [`examples/c/c-191-no-custom-crypto-policy.c`](../../examples/c/c-191-no-custom-crypto-policy.c)
**Deterministic test:** [`tests/c-191-no-custom-crypto-policy.sh`](../../tests/c-191-no-custom-crypto-policy.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to state and enforce a program-level rule that educational mixing code is not selectable for real protection.
...
A policy boundary prevents toy code from being promoted into production. Real cryptography requires maintained libraries, documented APIs, test vectors, and review.
