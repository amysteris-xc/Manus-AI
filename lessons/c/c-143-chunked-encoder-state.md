...
**Prerequisites:** C 001–142
**Companion program:** [`examples/c/c-143-chunked-encoder-state.c`](../../examples/c/c-143-chunked-encoder-state.c)
**Deterministic test:** [`tests/c-143-chunked-encoder-state.sh`](../../tests/c-143-chunked-encoder-state.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to carry a small encoder state across bounded input chunks without losing a partial unit.
...
Streaming state holds only a documented bounded remainder. Each chunk must be processed without assuming it ends on a logical boundary.
