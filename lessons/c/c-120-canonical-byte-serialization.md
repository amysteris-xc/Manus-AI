...
**Prerequisites:** C 001–119
**Companion program:** [`examples/c/c-120-canonical-byte-serialization.c`](../../examples/c/c-120-canonical-byte-serialization.c)
**Deterministic test:** [`tests/c-120-canonical-byte-serialization.sh`](../../tests/c-120-canonical-byte-serialization.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to serialize a small value in one documented canonical byte order.
...
Canonical output removes ambiguity for tests and comparisons. It is a format property, not encryption or authentication.
