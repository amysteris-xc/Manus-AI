...
**Prerequisites:** C 001–151
**Companion program:** [`examples/c/c-152-simulated-timeout-budget.c`](../../examples/c/c-152-simulated-timeout-budget.c)
**Deterministic test:** [`tests/c-152-simulated-timeout-budget.sh`](../../tests/c-152-simulated-timeout-budget.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to reduce a bounded operation budget deterministically and reject work after it is exhausted.
...
A local work budget is a teaching device for limits. It is not a network timeout or a replacement for system resource controls.
