...
**Prerequisites:** C 001–150
**Companion program:** [`examples/c/c-151-deterministic-clock-injection.c`](../../examples/c/c-151-deterministic-clock-injection.c)
**Deterministic test:** [`tests/c-151-deterministic-clock-injection.sh`](../../tests/c-151-deterministic-clock-injection.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to pass a controlled time-like value into a helper instead of reading ambient time in a deterministic test.
...
Injecting dependencies makes tests reproducible. The lesson models a numeric value, not a real scheduling or system-clock API.
