...
**Prerequisites:** C 001–051 and the immediately preceding lessons
**Companion program:** [`examples/c/c-052-byte-array-compaction-and-filtering.c`](../../examples/c/c-052-byte-array-compaction-and-filtering.c)
**Deterministic test:** [`tests/c-052-byte-array-compaction-and-filtering.sh`](../../tests/c-052-byte-array-compaction-and-filtering.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to compact a byte slice in-place by filtering out specified delimiter bytes.
