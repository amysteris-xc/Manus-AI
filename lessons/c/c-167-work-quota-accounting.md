...
**Prerequisites:** C 001–166
**Companion program:** [`examples/c/c-167-work-quota-accounting.c`](../../examples/c/c-167-work-quota-accounting.c)
**Deterministic test:** [`tests/c-167-work-quota-accounting.sh`](../../tests/c-167-work-quota-accounting.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to account for bounded work units while processing a controlled byte sequence.
...
Resource accounting should be explicit and monotonic. A rejected input must not reset or bypass a spent quota.
