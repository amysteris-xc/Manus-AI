...
By the end of this lesson, you should be able to centralize parser maximums as named constants and reject input above them.
...
Named limits make a format’s resource budget visible to reviewers and tests.
