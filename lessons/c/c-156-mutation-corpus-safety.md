...
**Prerequisites:** C 001–155
**Companion program:** [`examples/c/c-156-mutation-corpus-safety.c`](../../examples/c/c-156-mutation-corpus-safety.c)
**Deterministic test:** [`tests/c-156-mutation-corpus-safety.sh`](../../tests/c-156-mutation-corpus-safety.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to mutate a small in-memory byte case while retaining a known maximum length.
...
Mutation testing data belongs in a bounded buffer. Every generated case remains subject to the parser’s normal validation.
