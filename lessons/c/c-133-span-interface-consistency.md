...
**Prerequisites:** C 001–132
**Companion program:** [`examples/c/c-133-span-interface-consistency.c`](../../examples/c/c-133-span-interface-consistency.c)
**Deterministic test:** [`tests/c-133-span-interface-consistency.sh`](../../tests/c-133-span-interface-consistency.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to apply one consistent pointer-plus-length interface across related byte helpers.
...
A consistent span API handles null only with zero length, preserves explicit counts, and avoids sentinel scans.
