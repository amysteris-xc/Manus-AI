# C 139 — Strict Hex Decoding Round Trip

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–138
**Companion program:** [`examples/c/c-139-strict-hex-decode-round-trip.c`](../../examples/c/c-139-strict-hex-decode-round-trip.c)
**Deterministic test:** [`tests/c-139-strict-hex-decode-round-trip.sh`](../../tests/c-139-strict-hex-decode-round-trip.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to decode a validated even-length hexadecimal string into counted bytes.
...
Reject odd length and non-hex characters before writing output. A decoded byte count is explicit, not inferred from a sentinel.
