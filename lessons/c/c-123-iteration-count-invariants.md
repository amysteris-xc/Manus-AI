...
**Prerequisites:** C 001–122
**Companion program:** [`examples/c/c-123-iteration-count-invariants.c`](../../examples/c/c-123-iteration-count-invariants.c)
**Deterministic test:** [`tests/c-123-iteration-count-invariants.sh`](../../tests/c-123-iteration-count-invariants.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to state and test the count invariant of a bounded loop over a byte buffer.
...
A forward loop is safe when its index begins in range, advances predictably, and is compared with an explicit count.
