...
**Prerequisites:** C 001–194
**Companion program:** [`examples/c/c-195-continuous-integration-command-set.c`](../../examples/c/c-195-continuous-integration-command-set.c)
**Deterministic test:** [`tests/c-195-continuous-integration-command-set.sh`](../../tests/c-195-continuous-integration-command-set.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to state a portable command sequence for compiling and testing a C17 example.
...
Automation should run the same strict compiler flags and deterministic tests used locally. Do not claim that automation proves absence of defects.
