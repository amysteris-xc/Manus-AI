# C 096 — Record Reader and Writer Round Trip

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–095
**Companion program:** [`examples/c/c-096-record-reader-writer-round-trip.c`](../../examples/c/c-096-record-reader-writer-round-trip.c)
**Deterministic test:** [`tests/c-096-record-reader-writer-round-trip.sh`](../../tests/c-096-record-reader-writer-round-trip.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to write and read a fixed record through paired bounded APIs and compare the result.
...
Paired APIs need capacity checks at both ends and a test vector for the written form.
