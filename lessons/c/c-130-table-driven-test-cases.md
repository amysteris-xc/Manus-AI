...
**Prerequisites:** C 001–129
**Companion program:** [`examples/c/c-130-table-driven-test-cases.c`](../../examples/c/c-130-table-driven-test-cases.c)
**Deterministic test:** [`tests/c-130-table-driven-test-cases.sh`](../../tests/c-130-table-driven-test-cases.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to run a small static table of valid and invalid byte cases through one deterministic helper.
...
A table-driven test makes boundary cases visible and repeatable. Each row should state its expected outcome.
