...
**Prerequisites:** C 001–181
**Companion program:** [`examples/c/c-182-compatibility-matrix-tests.c`](../../examples/c/c-182-compatibility-matrix-tests.c)
**Deterministic test:** [`tests/c-182-compatibility-matrix-tests.sh`](../../tests/c-182-compatibility-matrix-tests.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to test selected producer and consumer version combinations with clear allowed and rejected outcomes.
...
Compatibility is a documented matrix. Unsupported combinations should fail deliberately rather than degrade silently.
