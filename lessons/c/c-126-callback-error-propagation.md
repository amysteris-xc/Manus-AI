...
**Prerequisites:** C 001–125
**Companion program:** [`examples/c/c-126-callback-error-propagation.c`](../../examples/c/c-126-callback-error-propagation.c)
**Deterministic test:** [`tests/c-126-callback-error-propagation.sh`](../../tests/c-126-callback-error-propagation.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to propagate a callback failure through a bounded iteration without continuing with invalid state.
...
A callback result is part of the caller’s contract. Stop at the first failure unless the API explicitly supports recovery.
