...
**Prerequisites:** C 001–180
**Companion program:** [`examples/c/c-181-tagged-union-regression-tests.c`](../../examples/c/c-181-tagged-union-regression-tests.c)
**Deterministic test:** [`tests/c-181-tagged-union-regression-tests.sh`](../../tests/c-181-tagged-union-regression-tests.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to assemble deterministic valid and invalid cases for a small tagged-union validator.
...
Regression cases should cover every tag, a wrong length, an unknown tag, and stable output after rejection.
