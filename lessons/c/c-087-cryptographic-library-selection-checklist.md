...
**Prerequisites:** C 001–086
**Companion program:** [`examples/c/c-087-cryptographic-library-selection-checklist.c`](../../examples/c/c-087-cryptographic-library-selection-checklist.c)
**Deterministic test:** [`tests/c-087-cryptographic-library-selection-checklist.sh`](../../tests/c-087-cryptographic-library-selection-checklist.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to encode a non-secret policy checklist for selecting maintained cryptographic libraries.
...
Choose maintained, documented, reviewed libraries and use their high-level APIs; do not roll custom crypto.
