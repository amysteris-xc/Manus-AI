...
By the end of this lesson, you should be able to validate a small nested length field while enforcing a maximum depth and capacity.
...
Nested structures need explicit maximum depth and size limits to resist resource exhaustion.
