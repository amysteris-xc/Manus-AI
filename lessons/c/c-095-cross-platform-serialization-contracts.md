...
**Prerequisites:** C 001–094
**Companion program:** [`examples/c/c-095-cross-platform-serialization-contracts.c`](../../examples/c/c-095-cross-platform-serialization-contracts.c)
**Deterministic test:** [`tests/c-095-cross-platform-serialization-contracts.sh`](../../tests/c-095-cross-platform-serialization-contracts.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to define fixed-width byte serialization that does not depend on pointer size or host endianness.
...
Formats should specify widths, byte order, and valid ranges independently of the local machine.
