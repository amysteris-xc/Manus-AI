# C 053 — Bitset Implementation on uint8_t Arrays

**Estimated study time:** 25–35 minutes
**Prerequisites:** C 001–052 and the immediately preceding lessons
...
By the end of this lesson, you should be able to implement bounded test and set operations on an arbitrary-length bitset.
