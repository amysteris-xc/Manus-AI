...
**Prerequisites:** C 001–030 and the immediately preceding lessons
**Companion program:** [`examples/c/c-031-counted-byte-substring-search.c`](../../examples/c/c-031-counted-byte-substring-search.c)
**Deterministic test:** [`tests/c-031-counted-byte-substring-search.sh`](../../tests/c-031-counted-byte-substring-search.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to search for a needle byte sequence inside a haystack buffer with explicit lengths.
