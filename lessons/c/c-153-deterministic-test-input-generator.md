...
**Prerequisites:** C 001–152
**Companion program:** [`examples/c/c-153-deterministic-test-input-generator.c`](../../examples/c/c-153-deterministic-test-input-generator.c)
**Deterministic test:** [`tests/c-153-deterministic-test-input-generator.sh`](../../tests/c-153-deterministic-test-input-generator.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to generate a repeatable small byte sequence for a test without depending on system randomness.
...
Test data should be reproducible. A deterministic generator is not suitable for secrets, cryptography, or security tokens.
