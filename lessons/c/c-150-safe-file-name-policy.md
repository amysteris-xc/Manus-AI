...
**Prerequisites:** C 001–149
**Companion program:** [`examples/c/c-150-safe-file-name-policy.c`](../../examples/c/c-150-safe-file-name-policy.c)
**Deterministic test:** [`tests/c-150-safe-file-name-policy.sh`](../../tests/c-150-safe-file-name-policy.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to validate a small allowlisted test-file label before using it in a local demonstration.
...
File-name policy should reject path separators, control characters, and unexpected lengths. This lesson is not a sandbox-escape or system-access technique.
