...
**Prerequisites:** C 001–117
**Companion program:** [`examples/c/c-118-duplicate-field-rejection.c`](../../examples/c/c-118-duplicate-field-rejection.c)
**Deterministic test:** [`tests/c-118-duplicate-field-rejection.sh`](../../tests/c-118-duplicate-field-rejection.sh)
**Author:** Manus AI

## What you will be able to do

By the end of this lesson, you should be able to detect a duplicated required field in a small tagged record.
...
When a format allows a field once, record that it was seen and reject a second occurrence before overwriting prior state.
